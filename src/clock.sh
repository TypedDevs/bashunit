...
function bashunit::clock::_choose_impl() {
  ...
  attempts[attempts_count]="Perl"; attempts_count=$((attempts_count + 1))
  ...
  attempts[attempts_count]="Python"; attempts_count=$((attempts_count + 1))
  ...
  # 3. Try Node.js
  attempts[attempts_count]="Node"; attempts_count=$((attempts_count + 1))
  if bashunit::dependencies::has_node; then
    _BASHUNIT_CLOCK_NOW_IMPL="node"
    return 0
  fi
  # 4. Windows fallback with PowerShell
  attempts[attempts_count]="PowerShell"; attempts_count=$((attempts_count + 1))
  ...
  attempts[attempts_count]="date"; attempts_count=$((attempts_count + 1))
  ...
  attempts[attempts_count]="EPOCHREALTIME"; attempts_count=$((attempts_count + 1))
  ...
  attempts[attempts_count]="date-seconds"; attempts_count=$((attempts_count + 1))
