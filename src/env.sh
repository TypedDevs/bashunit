...
_BASHUNIT_DEFAULT_SHOW_PROGRESS="true"
...
: "${BASHUNIT_SHOW_PROGRESS:=${SHOW_PROGRESS:=$_BASHUNIT_DEFAULT_SHOW_PROGRESS}}"
...
function bashunit::env::is_show_progress_enabled() {
