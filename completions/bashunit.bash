...
assert_is_directory_writable assert_is_file assert_is_file_empty assert_is_file_executable \
assert_is_file_not_empty assert_is_file_not_executable assert_is_file_not_readable \
assert_is_file_not_writable assert_is_file_readable assert_is_file_writable \
assert_is_not_symlink assert_is_symlink \
