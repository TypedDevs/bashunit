...
function test_unsuccessful_assert_file_exists() {
  ...
  assert_equals\
    "$(console_results::printFailedTest "Unsuccessful assert file exists" "$a_file" "to exist but" "do not exist")"\
...
function test_unsuccessful_assert_is_file() {
  ...
  assert_equals\
    "$(console_results::printFailedTest "Unsuccessful assert is file" "$a_file" "to be a file" "but is not a file")"\
